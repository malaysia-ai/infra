...
resource "aws_iam_role" "ebs_cni" {
  name               = "AmazonEKS_EBS_CSI_DriverRole_Data-ap-2"
...
resource "aws_acm_certificate" "mesolitica" {
  domain_name       = "malaysia-ai.org"
  subject_alternative_names = ["*.malaysia-ai.org"]
